									...
									<table class="table table-stripped">
										...
										while($row=mysqli_fetch_array($rec)){
											...
											<tr>
												...
												?>
													<a onclick="return checkdelete()" href="assets/data/session/delete.php?id=<?php echo $row[0];?>&login=<?php echo $row['coach_id']; ?>" class="btn btn-delete"><span class="fa fa-trash"></span></a>
												<?php
												}
												?>
												</td>
